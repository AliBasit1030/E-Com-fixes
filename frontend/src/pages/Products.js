...
const Products = () => {
  ...
  // Fetch categories and products only once on mount
  useEffect(() => {
    fetchCategories();
    fetchProducts(1);
  }, []);
    ...
    <div style={styles.container}>
      ...
      <div style={{ marginTop: 24, display: 'flex', justifyContent: 'center', gap: 8 }}>
        <button
          ...
          style={{ padding: '8px 16px', borderRadius: 4, border: '1px solid #ddd', background: currentPage <= 1 ? '#eee' : '#fff', cursor: currentPage <= 1 ? 'not-allowed' : 'pointer' }}
        >
          Prev
        </button>
        {Array.from({ length: pagination.last_page }, (_, i) => i + 1).map((page) => (
          <button
            ...
            style={{
              ...
              background: page === currentPage ? '#3498db' : '#fff',
        ...
        <button
          ...
          style={{ padding: '8px 16px', borderRadius: 4, border: '1px solid #ddd', background: currentPage >= pagination.last_page ? '#eee' : '#fff', cursor: currentPage >= pagination.last_page ? 'not-allowed' : 'pointer' }}
        >
          Next
        </button>
      </div>
